...
namespace MyArrayList
{
    public class ArrayList
    {
        ...
        public void AddFirst(int val) //AddFirst(int val) - добавление в начало списка
        {
            this.Length++;
            IncreaseCapacity();
        ...
        public void AddFirst(ArrayList otherList)
        {
        ...
        public void AddLast(ArrayList otherList)
        {
            Length += otherList.Length;
            IncreaseCapacity();
            int[] temp = new int[_capacity];
        ...
        public void AddAt(int idx, ArrayList otherList)
        {
            Length += otherList.Length;
            IncreaseCapacity();
            int[] temp = new int[_capacity];
        ...
        public void Reverse()
        {
            for (int i = 0; i < Length / 2; i++)
                MySwap(ref _array[i], ref _array[Length - 1 - i]);
        }
